...
Update of Nephlite, Telefonmasts mod https://steamcommunity.com/sharedfiles/filedetails/?id=2901034783
...
- [Set Up Camp](https://steamcommunity.com/sharedfiles/filedetails/?id=1470065926)


# Conflicts Warning:

- [SRTS Expanded](https://steamcommunity.com/workshop/filedetails/?id=2878587061), [Transport Shuttle](https://steamcommunity.com/sharedfiles/filedetails/?id=2879336912), [Transport Shuttle Standalone](https://steamcommunity.com/sharedfiles/filedetails/?id=2834132683)
...
Thanks to all  **[SRTS Expanded authors](https://steamcommunity.com/sharedfiles/filedetails/?id=1845423808)** for allowing their original code to be used and modified.
Thanks to **[Azazellz](https://steamcommunity.com/sharedfiles/filedetails/?id=2879336912)** for permission to use the modified code.


# Known Issues

- Auto drops all payloads as the carryall lands: This problem is almost impossible to solve by my ability. I will register as a contributor to this mod anyone who can solve this!

- Sometimes, once boarding is denied due to a weight or seat limit, the direct boarding command will not work even if the weight is subsequently corrected. This will only work again after fully resetting the cargo.

- Since items similar to those in my mod now exist in vanilla 1.6, this mod will discontinue support.
